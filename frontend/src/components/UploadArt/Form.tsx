...
const UploadArt = () => {
  ...
  const uploadIPFS = async () => {
    ...
    await fetch('https://eth-mainnet.g.alchemy.com/nft/v3/GDPZGLVRyXfR8mvXf5xi80OiOJx8oqX8/getNFTsForOwner?owner=0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045&withMetadata=true&pageSize=100', options)
      .then((response) => response.json())
      .then((response) => {
        // console.log(response);
        console.log(response.tokenUri);
        setIpfsUrl(response.tokenUri);
        if (displayImage) {
          toast({
